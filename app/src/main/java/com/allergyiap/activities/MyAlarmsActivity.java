...
public class MyAlarmsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button3 = (Button) findViewById(R.id.allergy);
        button3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                final CharSequence[] items = {" Wall Pellitory ", " Gramineae ", " Olive tree ", " Australian pine ",
                        " Chenopodiaceae/Amaranthaceae ", " Compositae ", " Cruciferae ",
                        " Cypress ", " Heath ", " Mercury "," Mugwort ", " Palms ", " Alternaria ", " Cladosporium "};
                // arraylist to keep the selected items
                final ArrayList seletedItems = new ArrayList();

                AlertDialog.Builder builder = new AlertDialog.Builder(v.getContext(), R.style.AlertsTheme);
                builder.setTitle("Select the allaergies to notify");
                builder.setMultiChoiceItems(items, null,
                        new DialogInterface.OnMultiChoiceClickListener() {
                            // indexSelected contains the index of item (of which checkbox checked)
                            @Override
